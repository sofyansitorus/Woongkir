...
class Raja_Ongkir {
	...
	private $couriers = array(
		'domestic'      => array(
			'pos'     => array(
				'label'    => 'POS Indonesia',
				'website'  => 'http://www.posindonesia.co.id/?utm_source=woongkir.com',
				'services' => array(
					'Surat Kilat Khusus',
					'Paketpos Biasa',
					'Paket Kilat Khusus',
			...
			'rpx'     => array(
				'label'    => 'RPX',
				'website'  => 'http://www.rpx.co.id/?utm_source=woongkir.com',
				'services' => array(
					'SDP',
					'MDP',
					'NDP',
			...
			'pcp'     => array(
				'label'    => 'PCP Express',
				'website'  => 'http://www.pcpexpress.com/?utm_source=woongkir.com',
				'services' => array(
					'ONS',
					'NFS',
					'REG',
			...
			'star'    => array(
				'label'    => 'Star Cargo',
				'website'  => 'http://www.starcargo.co.id/?utm_source=woongkir.com',
				'services' => array(
					'Express',
					'Reguler',
					'Dokumen',
			...
			'sicepat' => array(
				...
				'website'  => 'http://www.sicepat.com/?utm_source=woongkir.com',
				'services' => array(
					'REG',
					'BEST',
					'Priority',
			...
			'jet'     => array(
				'label'    => 'JET Express',
				'website'  => 'http://www.jetexpress.co.id/?utm_source=woongkir.com',
				'services' => array(
					'CRG',
					'PRI',
					'REG',
			...
			'sap'     => array(
				'label'    => 'SAP Express',
				'website'  => 'http://sap-express.id/?utm_source=woongkir.com',
				'services' => array(
					'REG',
					'SDS',
					'ODS',
			...
			'pahala'  => array(
				...
				'website'  => 'http://www.pahalaexpress.co.id/?utm_source=woongkir.com',
				'services' => array(
					'EXPRESS',
					'ONS',
				),
			...
			'slis'    => array(
				...
				'website'  => 'http://www.solusiekspres.com/?utm_source=woongkir.com',
				'services' => array(
					'REGULAR',
					'EXPRESS',
				),
			...
			'jnt'     => array(
				'label'    => 'J&T Express',
				'website'  => 'http://www.jet.co.id/?utm_source=woongkir.com',
				'services' => array(
					'EZ',
				),
				'account'  => array(
			...
			'wahana'  => array(
				...
				'website'  => 'http://www.wahana.com/?utm_source=woongkir.com',
				'services' => array(
					'DES',
				),
				'account'  => array(
		...
		'international' => array(
			...
			'expedito' => array(
				'label'    => 'Expedito',
				'website'  => 'http://www.expedito.co.id/?utm_source=woongkir.com',
				'services' => array(
					'CityLink',
					'DHL Indonesia',
					'DPEX',
